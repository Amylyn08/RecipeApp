...
public class UserTest {
    ...
    public void NameNotEnoughCharacters_Throws_ArugumentException() {
        //Act
        User Rida = new User("", "rida was here", "PrabBoss123", new List<Recipe>(), new List<Recipe>(), "Salt");
    }
    ...
    public void NameExceedsCharacters_Throws_ArugumentException() {
        //Act
        User Rida = new User("Riiiiiiiiiiiiida", "rida was here", "PrabBoss123", new List<Recipe>(), new List<Recipe>(), "Salt");
    }
    ...
    public void PasswordNotEnoughCharacters_Throws_ArugumentException() {
        //Act
        User Rida = new User("Rida", "rida was here", "Prab", new List<Recipe>(), new List<Recipe>(), "Salt");
    }
    ...
    public void DescriptionExceedsCharacters_Throws_ArugumentException() {
        ...
        //Act
        User Rida = new User("Rida", description, "PrabBoss123", new List<Recipe>(), new List<Recipe>(), "Salt");
    }

    [TestMethod]
    public void Constructor_Passes() {
        //Act
        User Rida = new User("Rida", "rida was here", "PrabBoss123", new List<Recipe>(), new List<Recipe>(), "Salt");
        //Assert
