...
public class UserTest {
    ...
    public void NullName_Throws_ArugumentException() {
        //Act
        User Rida = new User(null, "rida was here", "PrabBoss123", new List<Recipe>(), new List<Recipe>());
    }
    ...
    public void NameNotEnoughCharacters_Throws_ArugumentException() {
        //Act
        User Rida = new User("", "rida was here", "PrabBoss123", new List<Recipe>(), new List<Recipe>());
    }
    ...
    public void NameExceedsCharacters_Throws_ArugumentException() {
        //Act
        User Rida = new User("Riiiiiiiiiiiiida", "rida was here", "PrabBoss123", new List<Recipe>(), new List<Recipe>());
    }
    ...
    public void NullPassword_Throws_ArugumentException() {
        //Act
        User Rida = new User("Rida", "rida was here", null, new List<Recipe>(), new List<Recipe>());
    }
    ...
    public void PasswordNotEnoughCharacters_Throws_ArugumentException() {
        //Act
        User Rida = new User("Rida", "rida was here", "Prab", new List<Recipe>(), new List<Recipe>());
    }

    [TestMethod]
    public void NullDescription_BecomesEmptyString() {
        //Act
        User Rida = new User("Rida", null, "PrabBoss123", new List<Recipe>(), new List<Recipe>());
        //Assert
    ...
    public void DescriptionExceedsCharacters_Throws_ArugumentException() {
        ...
        //Act
        User Rida = new User("Rida", description, "PrabBoss123", new List<Recipe>(), new List<Recipe>());
    }

    [TestMethod]
    public void Constructor_Passes() {
        //Act
        User Rida = new User("Rida", "rida was here", "PrabBoss123", new List<Recipe>(), new List<Recipe>());
        //Assert
