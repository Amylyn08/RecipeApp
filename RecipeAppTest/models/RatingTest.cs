...
public class RatingTest {
    ...
    public void IllegalStarsForRatingMoreThan5(){
        ...
        int rating = 6;
        //Act
        Rating r = new(rating,"mama", new User("name", "mama","passsssss",new List<Recipe>(), new List<Recipe>()));
    }
    ...
    public void IllegalStarsForRatingLessThan0(){
        ...
        int rating = -1;
        //Act
        Rating r = new(rating,"mama", new User("name", "mama","passssssss",new List<Recipe>(), new List<Recipe>()));
    }
    ...
    public void StarsForRatingValid(){
        ...
        int rating = 2;
        //Act
        Rating r = new(rating, "mama", new User("name", "mama","passsssssss",new List<Recipe>(), new List<Recipe>()));
        //Assert
    ...
    public void descriptionExceeds256Characters(){
        ...
        //Act
        Rating r = new(3, description, new User("name", "mama","passsssssss",new List<Recipe>(), new List<Recipe>()));
    }
    [TestMethod]
    public void DescriptionIsEmptyStringIfNull(){
        ...
        string desc = null;
        //Act
        Rating r = new(5, desc, new User("name", "mama","passsssssss",new List<Recipe>(), new List<Recipe>()));
        //Assert
