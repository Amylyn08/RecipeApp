...
public class RatingTest {
    ...
    public void IllegalStarsForRatingMoreThan5(){
        //Arrange
        int rating = 6;
        User user = new("name", "mama","passsssss",new List<Recipe>(), new List<Recipe>(), "salt");
        //Act
    ...
    public void IllegalStarsForRatingLessThan0(){
        ...
        //Act
        Rating r = new(rating,"mama", new User("name", "mama","passssssss",new List<Recipe>(), new List<Recipe>(), "salt"));
    }
    ...
    public void StarsForRatingValid(){
        ...
        int rating = 2;
        //Act
        Rating r = new(rating, "mama", new User("name", "mama","passsssssss",new List<Recipe>(), new List<Recipe>(), "salt"));
        //Assert
